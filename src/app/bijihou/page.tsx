...
export default async function BijihouPage() {
  ...
  return (
    <div className="theme-kashikin pb-16">
      ...
      <ExamCountdown exams={BIJIHOU_EXAMS} accent="var(--c-kashikin)" accentSoft="var(--c-kashikin-soft)" periodExam lead="bijihou" calendar={{ examName: "ビジネス実務法務検定3級", path: "/bijihou/" }} examDate={{ exam: "bijihou", examName: "ビジネス実務法務検定3級" }} />
      ...
      <ExamDataSections exam="bijihou" questions={allQuestions} />
