...
export const metadata: Metadata = pageMetadata({
  path: "/bijihou2/mock/",
  title: "ビジネス実務法務検定2級 本番形式テスト｜採点・苦手分野判定つき",
  description:
    "ビジネス実務法務検定2級のオリジナル問題からランダム20問を出題。最後に得点と苦手分野を自動判定し、弱点を重点的に復習できます。登録不要・無料。",
});

export default async function Bijihou2MockPage() {
  ...
  return (
    <div className="theme-kashikin pb-16">
      ...
      <p className="text-xs text-[color:var(--c-text-sub)] mb-5">
        ...
        <a href="/bijihou2/moshi/" className="underline hover:no-underline">模擬試験 第1回（無料）</a>へ。
      </p>

      <MockExam
        exam="bijihou2"
        examLabel="ビジネス実務法務検定2級"
