...
export default async function BijimaneQuestionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="theme-bijimane pb-16">
      ...
      <AnswerReveal nextHref={nextQ ? `/bijimane/q/${nextQ.slug}/` : undefined} nextLabel={nextQ ? `次の問題（問${idx + 2}）へ` : undefined} choices={q.choices} correctAnswer={q.correctAnswer} explanationHtml={q.content} exam="bijimane" questionSlug={slug} courseAd={<BijimaneCourseAd />} />
