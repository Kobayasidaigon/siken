...
export const metadata: Metadata = pageMetadata({
  path: "/chintai/mock/",
  title: "賃貸不動産経営管理士 本番形式テスト｜採点・苦手分野判定つき",
  description:
    "賃貸不動産経営管理士のオリジナル問題からランダム20問を出題。最後に得点と苦手分野を自動判定し、弱点を重点的に復習できます。登録不要・無料。",
});

export default async function ChintaiMockPage() {
  ...
  return (
    <div className="theme-kashikin pb-16">
      ...
      <p className="text-xs text-[color:var(--c-text-sub)] mb-5">
        ...
        <a href="/chintai/moshi/" className="underline hover:no-underline">模擬試験 第1回（無料）</a>へ。
      </p>

      <MockExam
        exam="chintai"
        examLabel="賃貸不動産経営管理士"
