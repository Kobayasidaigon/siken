...
export const metadata: Metadata = pageMetadata({
  path: "/chizai/mock/",
  title: "知的財産管理技能検定3級 本番形式テスト｜採点・苦手分野判定つき",
  description:
    "知的財産管理技能検定3級のオリジナル問題からランダム20問を出題。最後に得点と苦手分野を自動判定し、弱点を重点的に復習できます。",
});

export default async function ChizaiMockPage() {
  ...
  return (
    <div className="theme-chizai pb-16">
      ...
      <p className="text-xs text-[color:var(--c-text-sub)] mb-5">
        本試験と同じ30問・45分・合否判定で腕試しするなら
        <a href="/chizai/moshi/" className="underline hover:no-underline">模擬試験 第1回（無料）</a>へ。
      </p>

      <MockExam
        exam="chizai"
        examLabel="知的財産管理技能検定3級"
