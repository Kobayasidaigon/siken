...
export const metadata: Metadata = pageMetadata({
  path: "/chizai2/",
  title: "知的財産管理技能検定2級 試験対策｜オリジナル問題を無料で",
  description: "知的財産管理技能検定2級のオリジナル練習問題を詳細解説。3級の一歩先、実務レベルの特許・著作権・意匠・商標・不正競争防止法・条約を分野別に演習できます。",
});
