...
export const metadata: Metadata = {
  ...
  // 正しい数は night-batch/index/matrix.json で確認できる。2026-09-01時点=11資格2,770問
  description: "シカクモンは資格試験のオリジナル練習問題を無料で提供するサイトです。貸金業務取扱主任者・個人情報保護士・知的財産管理技能検定3級/2級・マイナンバー実務検定3級・個人情報保護実務検定・ビジネス実務法務検定3級/2級・福祉住環境コーディネーター2級・ビジネスマネジャー検定・eco検定、合計2,770問。全問に根拠法令を含む詳細解説付き。",
  icons: {
    icon: "/favicon.svg",
  },
