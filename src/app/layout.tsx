      ...
      <body>
          ...
          <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm mb-6">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li><a href="/guide/" className="hover:text-white no-underline">勉強法</a></li>
                  <li><a href="/guide/difficulty/" className="hover:text-white no-underline">難易度</a></li>
                </ul>
              </div>
              <div>
        ...
        <nav className="sm:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 z-50">
          <div className="flex justify-around h-14 items-center text-xs">
            ...
            <a href="/guide/" className="flex flex-col items-center text-slate-500 hover:text-blue-700 no-underline">
