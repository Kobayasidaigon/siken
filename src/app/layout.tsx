...
export const metadata: Metadata = {
  ...
  // 正しい数は night-batch/index/matrix.json で確認できる。2026-09-09時点=17資格3,970問
  description: "シカクモンは資格試験のオリジナル練習問題を無料で提供するサイトです。貸金業務取扱主任者・個人情報保護士・知的財産管理技能検定3級/2級・マイナンバー実務検定3級・個人情報保護実務検定・ビジネス実務法務検定3級/2級・ITパスポート・賃貸不動産経営管理士・管理業務主任者・福祉住環境コーディネーター2級・ビジネスマネジャー検定・eco検定・情報サイバーセキュリティ管理士・教員採用試験・社会福祉士、合計3,970問。全問に根拠法令を含む詳細解説付き。",
  icons: {
    icon: "/favicon.svg",
  },
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 top-full pt-2 hidden group-hover:block">
                  <div className="bg-[color:var(--c-surface)] border border-[color:var(--c-border)] rounded-lg shadow-lg py-2 min-w-[220px]">
                    ...
                    <a href="/shakai/" className="flex items-center px-4 py-2 text-[color:var(--c-text)] hover:bg-[color:var(--c-bg-alt)] hover:text-[color:var(--c-eco)] no-underline transition-colors">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/tokushoho/" className="text-[color:var(--c-text-sub)] hover:text-[color:var(--c-ink)] no-underline">特定商取引法に基づく表記</a></li>
