...
export const metadata: Metadata = pageMetadata({
  path: "/mynumber/mock/",
  title: "マイナンバー実務検定3級 本番形式テスト｜採点・苦手分野判定つき",
  description:
    "マイナンバー実務検定3級のオリジナル問題からランダム20問を出題。最後に得点と苦手分野を自動判定し、弱点を重点的に復習できます。登録不要・無料。",
});

export default async function MynumberMockPage() {
  ...
  return (
    <div className="theme-pii pb-16">
      ...
      <p className="text-xs text-[color:var(--c-text-sub)] mb-5">
        本試験と同じ50問・75分で腕試しするなら
        <a href="/mynumber/moshi/" className="underline hover:no-underline">模擬試験 第1回（無料）</a>へ。
      </p>

      <MockExam
        exam="mynumber"
        examLabel="マイナンバー実務検定3級"
