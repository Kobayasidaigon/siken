...
export const metadata: Metadata = pageMetadata({
  path: "/mynumber/moshi2/print/",
  title: "マイナンバー実務検定 模擬試験 第2回｜印刷用",
  description:
    "マイナンバー実務検定の模擬試験 第2回を、問題・解答用紙・解説の順に A4 で印刷できます。ご購入者向けのページです。",
  noindex: true,
});
  ...
  return (
    <div className="pb-16">
      <nav className="breadcrumb text-xs text-[color:var(--c-text-sub)] mb-4 flex gap-1">
        <a href="/">ホーム</a>
        <span>/</span>
        <a href="/mynumber/">マイナンバー実務検定</a>
        <span>/</span>
        <a href="/mynumber/moshi2/">模擬試験 第2回</a>
        <span>/</span>
