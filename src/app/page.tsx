...
export const metadata: Metadata = {
  ...
  description: "シカクモンは資格試験のオリジナル練習問題を無料で提供するサイトです。貸金業務取扱主任者・個人情報保護士・知的財産管理技能検定3級/2級・マイナンバー実務検定3級・個人情報保護実務検定・ビジネス実務法務検定3級・福祉住環境コーディネーター2級・ビジネスマネジャー検定、合計2,204問。全問に根拠を含む詳細解説付き。",
  alternates: { canonical: "/" },
  openGraph: {
    url: "/",
    title: "シカクモン｜資格試験のオリジナル練習問題を無料で提供",
    description: "貸金業務取扱主任者・個人情報保護士・知財3級/2級・マイナンバー3級・個情保実務・ビジ法3級・福祉住環境2級・ビジマネの9資格、合計2,204問のオリジナル練習問題を無料公開。",
  },
};
