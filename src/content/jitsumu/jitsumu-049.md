...
examType: "jitsumu"
questionNumber: 49
title: "【問49】個人情報保護実務検定3級 練習問題｜プロファイリングと利用目的"
description: "個人情報保護実務検定3級試験対策。プロファイリングと利用目的に関するオリジナル練習問題と詳細解説。"
field: "取得・利用"
questionText: "事業者がユーザーの行動履歴を分析してプロファイリングを行う際の利用目的の特定に関する記述として、最も適切なものはどれか。"
choices:
  - "プロファイリングを行う場合でも、特に明示する必要はなく「マーケティング目的」のみの記載で足りる"
  - "ガイドラインの令和4年改正により、本人に関する行動・関心等の情報を分析して個人情報を取り扱う場合は、その旨を明示することが望ましいとされている"
