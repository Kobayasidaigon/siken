...
// 情報・サイバーセキュリティ管理士認定試験。年4回、協会の共通日程で実施される。
// 2026-09-08 に確認。本環境から協会サイト(joho-gakushu.or.jp)へ到達できないため、
// 協会の令和8年度試験日程ページを引用する検索結果から日付を取った:
//   ・2027-03-14 = 第64回。申込 2026-11-16〜2027-01-28（回次・申込期間とも出典あり）
//   ・2026-12-13 = 申込 2026-08-31〜2026-10-29（申込期間は出典あり。回次は未確認のため
//     label に回次を書かず「2026年12月試験」としてある）
// いずれも PII_EXAMS / MYNUMBER_EXAMS の同月の回と試験日・申込期間が完全に一致しており、
// 協会が全検定を共通日程・共通の申込ウィンドウで回していることと整合する。
// ※ TODO(isec): 協会の公式ページで回次と日付を1度確認し、12月回の回次を label に入れること。
//   申込締切を1日でも誤ると、締切前CTAが誤った期限を出す。
export const ISEC_EXAMS: UpcomingExam[] = [
  { date: "2026-12-13", label: "2026年12月試験", applyStart: "2026-08-31", applyEnd: "2026-10-29" },
